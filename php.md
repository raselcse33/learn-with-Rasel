...
Logical and comparison Operations (like &&, || , > ,
Comparisons example :     
$b;  // Comparison: 10 is greater than 5, so $is_greater is true
...
First Iteration:
Initialization: $i = 1
Condition: $i "; // Output: Number: 1
Increment: $i++ makes $i = 2
Second Iteration:
Condition: $i "; // Output: Number: 2
Increment: $i++ makes $i = 3
Third Iteration:
Condition: $i "; // Output: Number: 3
Increment: $i++ makes $i = 4
Fourth Iteration:
Condition: $i "; // Output: Number: 4
Increment: $i++ makes $i = 5
Fifth Iteration:
Condition: $i "; // Output: Number: 5
...
[ এখানে আমি চক্র বলতে যেটা বুঝতে চেয়েছে সেটা হল। $i = 1; $i 
...
উদাহরণ : 
";
echo "তোমার ব্রাউজার: " . $_SERVER['HTTP_USER_AGENT'] . "";
?>
...
Upload
$file = $_FILES['myfile'];
✔️ $_FILES হলো সুপারগ্লোবাল ভেরিয়েবল (এরে ) যা ফর্মের ফাইল ইনপুট () থেকে ফাইল এর  ডাটা নিয়ে আসে, 
...
echo "✅ ধন্যবাদ! Divide করার চেষ্টা শেষ।";
}
}
Output হবে:
ফলাফল: 5
...
Singleton : Singleton হল php একটা ডিসাইন pattern . যার মূল কনসেপ্ট হল। একটা class এর একটাই object (new লিখে যে object তৈরী করি ) থাকবে। বার বার new লিখে object তৈরী করা যাবে না। আর এই rule বা pattern টাই হল  Singleton pattern . 
