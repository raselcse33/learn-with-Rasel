...
## scripting language : স্ক্রিপ্টিং ল্যাঙ্গুয়েজে হচ্ছে এক প্রকার প্রোগ্রামিং ল্যাঙ্গুয়েজে যেটা  compilation ছাড়াই excute হয়। 
    example : php ,javascript 

## of Non-Scripting  Languages : নন স্ক্রিপ্টিং ল্যাঙ্গুয়েজে হচ্ছে Compiled ল্যাঙ্গুয়েজে।  মানে এই ল্যাঙ্গুয়েজে টাকে কম্পিউটার এ রান করার পূর্বে  এটি কে compiled অর্থাৎ মেশিন ল্যাঙ্গুয়েজে (বাইনারি কোড এ ) রূপান্তর করতে হবে। 
    example : c ,c ++,java 

## compiled : compilied হলো সেই জায়গা যেখানে আমার লেখা কোড টাকে machine language  (binary code) convert করা হয়, যাতে কম্পিউটার বুজতে পারে এবং ঠিক ভাবে রান করতে পারে। 

## how scripting language run : যেহেতু স্ক্রিপ্টিং ল্যাঙ্গুয়েজে compiled করার প্রয়জন পরে না।  
    তাই ইটা রান করার জন্য ব্যবহার  করা হয়  the interpreter (often part of the web server, like Apache or Nginx) এরা কোড লাইন বা লাইন পরে।  
    machine instructions এর মতো করে যাতে কম্পিউটার বুজতে পারে। 

## php ভার্সন চেক করার জন্য ব্যবহার করা হয় : phpversion()

## Web Host : ওয়েব হোস্ট হলো একটা নির্ধারিত জায়গা যেখানে ওয়েবসাইট এর ফাইল রাখা হয়. অনেকটা ভাড়া করা জায়গার মতো। যেখানে যে কেউ তার মনের মত স্পেস ভাড়া করতে পারে তার ওয়েবসাইট এর জন্য। Bluehost, HostGator, and GoDaddy. এই কোম্পানি গুলো এই স্পেস ভাড়া দেয়। 
## Web Server: ওয়েব সার্ভার হলো একটা টুল (tool) or software যেটা আমার ওয়েবসাইট রান করতে এবং ভিসিটরদের দেখতে সাহায্য করে। like Apache or Nginx server .

## xammp : xammp হলো একটা সফটওয়্যার প্যাকেজ বা ম্যানেজিং  টুল এর মতো যেটা আমার পিসি কে একটা লোকাল ওয়েব সার্ভার বানিয়ে ফেলতে পারি ।
...
## case sensitivity : case sensitivity বলতে এইটা বুঝায় যে কোনো একটা লেটার বা ওয়ার্ড uppercase বা lowercase লিখলে এইটা কি একই না ভিন্ন অর্থ বুঝায়। 
    যেমন : Apple ,apple দুইটা কি একই না ভিন্ন। 
## Case sensitive : Case sensitive এর ক্ষেত্রে Apple ,apple দুইটা ভিন্ন। 
## Not case sensitive: Not case sensitive এর ক্ষেত্রে Apple ,apple দুইটা একই। 
    তবে php user  define classes  এবং function এর ক্ষেত্রে এই নিয়ম মানে না.
    যেমন :  if, else, while, echo,

## php Comment : php comment মানে এই লাইন গুলো বা এই কোড গুলো excute হবে না। 
    php কমেন্ট ২ টাইপ single and multiple 
...
## variable : যেখানে value assign করা থাকে 
    var_dump() function এর মাধ্যমে আমরা variable টাইপ জানতে পারি .

## loosely typed language : PHP হল loosely typed language. এর মানে এখানে ভ্যারিয়েবল declured করার সময় বলার প্রয়জন হয় না যে ইটা কোন টাইপ এর ভ্যারিয়েবল ,ভ্যালু দেখেই সে বুজে ফেলে যে ইটা কোন টাইপ ভ্যারিয়েবল। 
...
## variable scope : variable scope মানে হচ্ছে variable টাকে কোন কোন জায়গা থেকে access করা যাবে। কারণ সব ভ্যারিয়েবল সব জায়গা থেকে access করা যাই না। 
    three main types of variable scope in PHP:

## Local Scope:  Local Scope হচ্ছে এই ভ্যারিয়েবল যেখানে declured করা হয়েছে শুধু ঐখানে একে এক্সেস করা যাবে আর একেই Local Scope বলে. এর মানে কোনো  ভ্যারিয়েবল function এর ভিতর declured করলে  কেবলমাত্র ফাঙ্কশন এর ভিতরই access করা যাবে। এর বাহির থেকে এক্সেস করা যাবে না .
        <?php
        function myFunction() {
...
## Global Scope : Global Scope বা ভ্যারিয়েবল হলো ,ফাঙ্কশন এর বাহিরে যে কোনো variable কে Global Scope বা Global variable বলে। এটা function ভিতর ছাড়া script যে কোনো জায়গা থেকে এক্সেস করা যায় 
        <?php
...
### Static Scope : সাধারণত function এর ভিতর কোনো ভ্যারিয়েবল declured করলে , যখন ওই function টা রান হয় এবং শেষ হয় তখন ওই ভ্যারিয়েবল টা তার ভ্যালু delete করে দেয়। কিন্তু যদি variable এর আগে Static অ্যাড করা হয় তখন ওই ভ্যারিয়েবল টা , 
...
###echo : echo কোনো ভ্যালু রিটার্ন করে না। এটা সিম্পলি আউটপুট শো করে। 
           echo print এর থেকে ফাস্ট কারণ এটা কোনো ভ্যালু রিটার্ন করে না। 

###print : print ভ্যালু ১ রিটার্ন করে। এবং এটা expressions এর জন্য ব্যবহার হয়।  
        example : <?php
        if (print("Hello")) {
            echo " - The print function returned 1, so this message is shown.";
        }
        ?>
        এখানে print("Hello") এর মানে হলো এটা একটা স্ট্রিং hellow প্রিন্ট করছে এবং  1 ভ্যালু রিটার্ন করে কারণ আমরা জানি  প্রিন্ট সবসময় 1রিটার্ন করে। 
...
### why 1 is True :  php তে 1 সবসময় true হিসাবে ব্যবহার  হয়। এবং 0 false হিসাবে ব্যবহার হয়। 
    example :  
            <?php
            if (1) {
...
### expressions :  expressions হলো value ,variable ,operator and function এর একটা combination যেটা একটা রেজাল্ট তৈরী  করে (সিঙ্গেল value ) .
...
### Data Type : Data  type বলতে বুঝায় ,একটা ভ্যারিয়েবল কি ধরণের  type of data (value ) hold বা ধারণ করে। 
##### PHP has 8 main data types:
            String : String হলো একটা sequence of characters (অক্ষরের ক্রম বিনাস।এর মানে হলো প্রত্যেকটা character এর পর  আরেকটা character সাজানো থাকে। যেমন "CAT"   এখানে C A এবং T একটা সিকোয়েন্স মেইনটেইন করে একটার পর একটা রয়েছে। ) 
            ...
            Integer: Integer বলতে বুঝায় সমস্ত নাম্বার কে (Negativ এন্ড পসিটিভ )। তবে decimal নম্বর ছাড়া।     

            Float (or Double): Float (or Double) বলতে আমরা decimal নম্বর কে বুঝি। 

            Boolean : Boolean হলো এক ধরণের data Type যেটা true এবং false এই দুই টা state নিয়ে কাজ করে।
                ...
                Type Casting : Type Casting হলো একটা process যার মাধ্যমে value একটা data type থেকে আরেকটা data type convert হয়।    
                ...
                Array : Array হলো এমন একটা ভ্যারিয়েবল যেখানে  multiple ভ্যালু assign করা যায়। এবং সেই ভ্যালু গুলোকে index এর মাধ্যমে এক্সেস করা যায়।             
                        example : 
                        <?php
                ...
                Object : Object হল instance of class . মানে হচ্ছে object হল class এর একটা বাস্তব উদাহরণ। যেমন car যদি একটা class হয় তাহলে এর উদাহরণ বা instance হলো Toyota .   
                ...
                NULL: NULL হচ্ছে  একটা special  ভ্যালু যেটা represents করে no-value অথবা empty । তাই কোনো ভ্যারিয়েবল কে null ভ্যালু এসাইন করা মানে হলো ঐ ভ্যারিয়েবল টা empty অথবা স্পষ্টভাবে কোনো ভ্যালু এসাইন করা নাই।সহজ ভাবে বলতে গেলে Declaring without a value . 
                        তবে এখানে একটা কথা থাকে    
                            
                        $car;
                        $car2 = NULL;
                        এখানে দুই টা ভেরিএবলে আছে যার প্রথমটা শুধু একটা ভ্যারিয়েবল declured করা আছে যার কোনো ভ্যালু নেই। এবং দ্বিতীয়টা একটা special null ভ্যালু assign করা আছে যার অর্থ এর ও কোনো স্পষ্টভাবে ভ্যালু এসাইন করা নাই।  তাহলে কি দুই টা একই। 

                        $car;
                        PHP জানে যে $car  কোডে উল্লেখ করা হয়েছে , কিন্তু এটা এখন ও একটা initialized variable এর মত আচরণ করে না। 
                        initialized variable এর মানে হলো variable টাতে intial ভ্যালু (প্রাথমিক ভাবে বা প্রথম বার যে ভ্যালু  assign করা হয়। )  assign করা হয়েছে। 
                        মূলকথা হল $car  যেহেতু কোডে লিখা হয়েছে সেহেতু এটা exit করতেসে কিন্তু PHP একে কোনো memory allocation অর্থাৎ memory তে কোনো জায়গা বরাদ্দ রাখে না। 
                ...
                Resource : Resource হচ্ছে PHP এর একটা special ডাটা টাইপ যেটা external resource নিয়ে কাজ করে। external resource মানে হচ্ছে PHP Program এর বাহিরে যে কোনো data টাইপ অথবা service, যেটাকে PHP program থেকে accessed করা যাবে। 
    ...
    আমরা জানি string টাইপ এর ডাটা বা  ভ্যালু  Double Quotes (") এবং Single Quotes (') এর ভিতর লিখা হয়। তবে লিখা হলেও এই Double Quotes (") এবং Single Quotes (') এর ভিতর রয়েছে পার্থক্য। 
                     
        Double Quotes : 
                     
            *এর প্রথম যে বৈশিষ্ট সেটা হলো Double Quotes এর ভিতর আমরা ভ্যারিয়েবল লিখতে পারি। এবং সেটা ভ্যারিয়েবল এর মত আচরণ করে।আর এই কথাটাকে ইংলিশ বলে (interpolated) .  একটা উদাহরণ দিলে আরো সহজ হবে। 
                $name = "John";
...
##PHP Constant : আমরা জানি যার মধ্যে ভ্যালু assign করা হয় তাকে ভ্যারিয়েবল বলে। PHP Constant : আমরা জানি যার মধ্যে ভ্যালু assign করা হয় তাকে ভ্যারিয়েবল বলে। 
                   যেমন : $name = "খেলা হবে "; 
                ...
                এটা কে define() অথবা  const দিয়া শুরু করতে হয়। 
                    উদাহরণ : define("SITE_NAME", "MyWebsite");
            ...
            ********************PHP Operators*************
            ...
            #### PHP তে Operators বলতে বুঝায় কিছু  symbol বা keyword (keyword বলতে এখানে reserve keyword বুঝানো হয়েছে।  যেমন if ,else ইত্যাদি  ). যেটা ব্যবহার হয় variableবা value এর উপর। বিভিন্ন রকম action  ঘটানোর জন্য। 
...
#### PHP IF  statement সাধারণত ব্যবহার করা condtion চেক করার ক্ষেত্রে। condtion যখন true হয়।  তখন ওই condition এর ভিতর code টুকু রান হয়। নিচে উদাহরন দেয়া হল 
...
##### Loop : Loop ও এক প্রকার connditional statement .এটি একটি কাজ বা বার বার করে (প্রোগ্রামিং এর ভাষায় : কোড এর একটি নির্দিষ্ট block বার বার excute করে ) যতক্ষণ না condtion টা false হচ্ছে। 
            php তে চার প্রকার loop আছে , while Loop,do-while Loop,for Loop,foreach Loop
            ...
            **do-while Loop : 
                ...
                তবে while Loop এবং do-while Loop এর মধ্যে একটা পার্থক্য আছে। সেটা হলো while Loop প্রথমে condition  check করে ,এরপর  condtion true হলে সে ওই কোড টুকু excute করে। 
...
### Break Statement : Break Statement টা ব্যবহার করা হয় কোনো loop কে তাৎক্ষণিক ভাবে exit বা শেষ করার জন্য ,যদিও লুপ এর condition true . একটা উদাহরণ দিলে আরো ভালো বুঝা যাবে। 
                    ...
                    কিন্তু loop এর ভিতর আরেকটা  condition use করা হয়েছে। যখন ওই condition true হবে তখন break statement  কোড টাকে exit করে দিবে ,যদিও loop এর condition এখনো true ।এটাই হল ব্র্যাক statement কাজ  

 
### Continue : continue statement সাধারণত ব্যবহার করা হয়  কোনো একটা loop ( চক্র ) কে স্কিপ করার জন্য ।এবং ওই loop (চক্র) কে স্কিপ করে পরবর্তী যে চক্র বা লুপ আছে ওইটা continue করে। 
...
#####PHP Function : php function হচ্ছে code এর ভিতর একটা নির্দিষ্ট block যেটা একটা নির্দিষ্ট কাজের জন্য ব্যবহার হয়। 
                    [code হচ্ছে একটা instructions (নির্দেশনা) বা command যেটা কোনো programming language লেখা হয় , যাতে করে কম্পিউটার ওই instructions অনুযায়ি কাজ করতে পারে (excution করতে পারে )।
                    আমরা জানি code লেখা হয় programming ল্যাঙ্গুয়েজে দিয়ে। প্রত্যেক single লাইন code কোনো না কোনো কাজের  নির্দেশনা দেয় computer কে  যে তুমি এটা কর , তখন compute ওই কাজ টা করে এবং আমরা তার রেজাল্ট টা দেখতে পাই। 
                    মোটকথা computer এর সাথে commnucation একটা মাধ্যম হল কোড [ (programming ল্যাঙ্গুয়েজে) . অন্য ভাবে বললে programming language এর লিখিত রূপ হল কোড].
...
######PHP বিভিন্ন ধরণের function রয়েছে নিচে আলোচনা করা হল 
        ...
        Built-in Functions : Built-in Functions হল আগের থেকে define বা তৈরী  করা function যেটার কোনো পরিবর্তন বা modification করা যাবে না। শুধু ব্যবহার করা যাবে। 
                                php তে এরকম অনেক Built-in Functions রয়েছে কাজকে সহজ করার জন্য 
                                উধাহরন :
        ...
        ***************************** Array ***********************************************
        ...
        Type of Array:
                ...
                USES : Indexed Arrays ব্যবহার করা  sequential data (like a list or collection) store করার জন্য  . আর Associative Arrays বেবহার করা হয় meaningful keys সহ ডাটা store করার জন্য। 
                ...
                Multidimensional arrays : Multidimensional arrays বলতে বুঝায় যেখানে একটা array তার ভ্যালু হিসাবে array রাখে। আমরা জানি array এমন একটা ডাটা টাইপ বা ভ্যারিয়েবল  যেখানে  একাধিক ভ্যালু assign করা যায়। 
               ...
               এটা একটা Two-Dimensional Array . কারণ এখানে $products একটা main array ,এবং এর মধ্যে যে ভ্যালু গুলো assign  আছে, সেগুলো ও এক একটা array . এবার আসি এটা কিভাবে  row এবং column মতো আচরণ করে। এখানে main Array টা হচ্ছে row এবং এর ভিতর যে ভ্যালু হিসাবে array গুলো আছে সেগুলো হচ্ছে column . অর্থাঃ 
     ...
     2️⃣ প্রতিটি মানের জন্য একটি Memory Address থাকে, যেমন:
      ...
      8. $_SESSION এবং $_COOKIE একই জিনিস নয়, বরং এদের মধ্যে কিছু পার্থক্য আছে।
          ...
          $_SESSION 
            ...
            ৩. বেশি নিরাপদ, কারণ ডাটা সার্ভারে থাকে।  $_SESSION এর ডাটা সার্ভারের টেম্পোরারি মেমোরিতে (RAM) বা ফাইল সিস্টেমে সংরক্ষণ হয়।
                সাধারণত /tmp/sess_abc123 এরকম ফোল্ডারে ফাইল তৈরি হয়।

            ৪. $_SESSION ব্যবহার করে সার্ভারে থাকা ডাটা অ্যাক্সেস করা যায়

            ৫. $_SESSION ব্যবহার করুন যখন ডাটা সিকিউর রাখতে চান, যেমন লগইন ইনফরমেশন।
    ...
    ***************************** PHP Advance ***********************************************       
    ...
    PHP include এবং require : PHP-তে include এবং require দুটি ফাংশন ব্যবহার করা হয় একটি ফাইলকে অন্য ফাইলে অন্তর্ভুক্ত করার জন্য। নিচে উদাহরণ দেয়া হল 
     ...
     include : include ব্যবহার করলে যদি ফাইলটি না পাওয়া যায়, তাহলে PHP একটি Warning (E_WARNING) দেখাবে,
    ...
    include_once এবং require_once : 
                ...
                ***************************** PHP File Handling (ফাইল হ্যান্ডলিং)  *****************************

               PHP-তে ফাইল নিয়ে কাজ করা অনেক দরকারি। file Handling  মাধ্যমে  আপনি ফাইল থেকে ডাটা পড়তে (read), লিখতে (write), এডিট করতে (append) বা ডিলিট করতে (delete) পারবেন।

                PHP ফাইলের সাথে কাজ করার জন্য প্রধানত ৪টি ধাপ অনুসরণ করা হয়:
                1️⃣ ফাইল ওপেন (Open)
                2️⃣ ফাইল থেকে পড়া (Read) বা লেখা (Write)
                3️⃣ ফাইল বন্ধ (Close)
                4️⃣ ফাইল ডিলিট (Delete) (যদি প্রয়োজন হয়)

        🚀 ১. ফাইল ওপেন করা (fopen()) : PHP-তে fopen() ফাংশন ব্যবহার করে ফাইল ওপেন করা হয় file open জন্য 

            📌 fopen() Modes (মোডসমূহ) : fopen() Modes বলতে বুঝাই একটি ফাইল কি modes এ ওপেন করা হবে। একটি ফাইল বিভিন্ন modes এ
            ওপেন করা যায়। নিচে দেয়া হল 
            
            "r"	Read Mode (শুধু পড়ার জন্য, ফাইল ওপেন হবে)
            "w"	Write Mode (লেখার জন্য,মানে আগের ডাটা মুছে নতুন ডাটা লেখে)
            "a"	Append Mode (শেষে নতুন লেখা যোগ করতে)
            "x"	Create Mode (নতুন ফাইল তৈরি করবে, ফাইল থাকলে error দেবে)

            ✅ উদাহরণ:
                    <?php
                        $file = fopen("myfile.txt", "r"); // "r" মানে শুধু পড়ার জন্য ওপেন করা হলো
                    ?>


        🚀 ২. ফাইল থেকে ডাটা পড়া (Read) :

            ✅ fread() – ফাইলের সবকিছু পড়তে ব্যবহার হয় 

                উদাহরণ : 
                    <?php
                        $file = fopen("myfile.txt", "r");
                        $content = fread($file, filesize("myfile.txt")); // পুরো ফাইল পড়া
                        echo $content;
                        fclose($file);
                    ?>
                📌 এখানে filesize("myfile.txt") দিয়ে পুরো ফাইলের সাইজ নেওয়া হয়েছে, যেন fread() পুরো ফাইল পড়ে নিতে পারে।


        ✅ fgets() – ফাইলের একটি লাইন পড়তে ব্যবহার হয় 
        
                <?php
                $file = fopen("myfile.txt", "r");
                echo fgets($file); // প্রথম লাইন পড়বে
                fclose($file);
                ?>

         ✅ feof() – এটি ফাইলের শেষ পর্যন্ত লুপ চালানোর জন্য ব্যবহার করা হয়,📌 যাতে  পুরো ফাইল লাইন-বাই-লাইন পড়া যায় ।  
        ...
        ✅ fwrite() – এটি  ফাইলে নতুন ডাটা লিখতে ব্যবহার করা হয়,এবং ফাইল এ যদি আগে কোনো ডাটা থাকে তাহলে সেটি মুছে যাবে ,
        
            <?php
                $file = fopen("myfile.txt", "w"); // "w" মোড মানে আগের ডাটা মুছে নতুন ডাটা লেখে
        ...
        ✅ a মোড দিয়ে আগের ডাটা মুছে না ফেলে নতুন ডাটা যোগ করতে পারেন:        

            <?php
                $file = fopen("myfile.txt", "a"); // "a" মোড মানে আগের ডাটা রেখে নতুন ডাটা যোগ করা হবে
                fwrite($file, "\nAppending new line.");
                fclose($file);
            ?>

        🚀 ৪. ফাইল ডিলিট করার ক্ষেত্রে  (unlink()) ব্যবহার করা হয়    
                <?php
                unlink("myfile.txt"); // ফাইল ডিলিট হবে
                ?>
    ...
    🔹 $file['name'] → ফাইলের অরিজিনাল নাম পাওয়া যাচ্ছে (যেমন: image.jpg)
    🔹 $file['tmp_name'] → ফাইল আপলোড হওয়ার পর, সেটি সার্ভারের টেম্পোরারি লোকেশনে রাখা হয় (এটি সার্ভারের /tmp/ ফোল্ডারে 
    ...
    🔹 $file['size'] → ফাইলের সাইজ (বাইটে)
    🔹 $file['error'] → চেক করা হচ্ছে কোনো এরর হয়েছে কিনা
    🔹 $file['type'] → ফাইলের টাইপ (যেমন: image/jpeg, image/png)
  ...
  1️⃣ Session:
 🔹 পার্কে ঢোকার সময় আমাকে একটা প্রবেশ টিকিট (ID) দেওয়া হলো, যা পার্কের মালিকের কাছে সংরক্ষিত  আছে ।
 🔹 যতক্ষণ আমি পার্কের ভিতরে থাকবো , ততক্ষণ আমি পার্কে ঘুরার এক্সেস পাবো। কারণ আমার টিকেটটি পার্কের মালিকের কাছে আছে। 
 🔹 কিন্তু যখন আমি  পার্ক থেকে বের হয়ে যাব , তখন আমার টিকেটটি মালিক ফেলে দিবে। ফলে আমাকে আবার পার্কে ঢুকতে হলে আমাকে 
      আবার টিকেট নিতে হবে। 
...
2️⃣ Cookies:
🔹 এবার ধরো, পার্কের ঢুকার সময় আমার হাথে  আমাকে একটা ছোট স্টিকার (Token) দেওয়া হলো, যেখানে আমার নাম লেখা আছে। এবং এর একটা এক্সেস টাইম দেয়া আছে। 
🔹এখন আমি ওই সময় এর মধ্যে যতবার ইচ্ছা পার্কে ঢুকতে পারবো এবং বের হতে পারবো ,যতক্ষণ না আমার এক্সেস টাইম শেষ হচ্ছে। যেহেতু আমার হাতে স্টিকার আছে সেহেতু পার্কের মালিক ও আমাকে চিনবে। 
...
✅ কোথায় ব্যবহার করবো?
  "Remember Me" অপশন তৈরি করতে, যাতে ইউজার পরে লগইন করতে না হয়
  Language change  এর ক্ষেত্রে এটি ব্যবহার করা হয়। উদাহরণ স্বরূপ আমি একটা ওয়েবসাইটে ঢুকলাম যেখানে দুই টা language  আছে ইংলিশ  এবং বাংলা ,আমি বাংলা সিলেক্ট করলাম। এখন পরেরবার যখন আমি এই  ওয়েবসাইটে ঢুকব, তখন বাংলা language  টাই দেখাবে। 
🔹 Cookies সেট করার জন্য setcookie() ফাংশন ব্যবহার করতে হবে।
    ...
    PHP Filter কাজ হল ইনপুট data চেক করা। যাতে ইউজার ভুল বা খারাপ ডাটা না পাঠাতে পারে। নিচে এর কিছু উদাহরণ দেয়া হল। 
        ...
        ***************************************Call back Functionr**********************************************
        ...
        একটা function-এর ভিতরে যখন অন্য একটা function কে "parameter" হিসেবে পাঠানো হয় — এবং parameter হিসাবে পাঠানো ওই ফাঙ্কশন টাকে call করা হয় তখন তাকে Callback Function বলে। 
        ...
        *********************************OOP*****************************************************
        OOP  : Object-Oriented Programming (OOP) হচ্ছে এমন একটা প্রোগ্রামিং স্টাইল যেখানে আমরা সব কিছু object হিসেবে দেখি।
               সহজ ভাবে যেখানে আমরা class আর object দিয়ে কোড লিখি    

        Class : Class হলো একটা নকশা (blueprint) — যেখানে আমরা বলে দিই একটা জিনিস কেমন হবে, তার কি কি গুণ (property) থাকবে, আর সে কী কী কাজ (method) করতে পারবে। ধরা যাক আমি একটা গাড়ির বানানোর  নকশা তৈরী করবো ,সেখানে গাড়ির color ,brand ইত্যাদি বিষয় থাকবে। 
        ...
        Object : Object হলো class থেকে বানানো আসল জিনিস [ওই নকশা থেকে বানানো আসল জিনিষটা ] — মানে, সেই নকশা থেকে বানানো গাড়িটা ।
        ...
        Constructor : Constructor হলো একটা Special Function (বিশেষ ফাংশন) এটাকে আবার magic function ও বলা হয়। যখন কোনো class এর 
         ...
         Destructor : Destructor হলো একটা Special Function (বিশেষ ফাংশন) এটাকেও  magic function বলা হয়। কোন class যখন object তৈরি করি তখন Destructor function টা অটোমেটিক call হয়,Constructor এর মত। 
        ...
        ✅ Access Modifier :  Access Modifier একটি ক্লাস এর প্রপার্টি এবং মেথড কে কত টুকু access করতে পারবে সেটা নির্ধারণ করে। 
            ...
            Public : কোন property বা মেথড এর আগে public থাকলে এটা সব জায়গা থেকে access করা যাবে (class এর ভিতর, class এর বাইরে, এমনকি অন্য class থেকেও)। 
                    নিচে আলোচনা করা হল। 

                    
                    class এর ভিতর : ক্লাস এর ভিতর যে মেথড বা প্রপার্টি আছে , ওই মেথড বা প্রপার্টি কে যদি ওই ক্লাস এর ভিতরের অন্য কোনো প্রপার্টি বা মেথড এক্সেস করে তখন তাকে ক্লাস এর ভিতর বলে 
                   ...
                   class এর বাইরে : class এর বাইরে বলতে বুঝায় , object বানিয়ে class এর property/method use করা       
                            
                            উদাহরণ :   $car1 = new Car();        // class এর বাইরে object বানানো
                                        echo $car1->brand;        // বাইরে থেকে public property access করা
                                        $car1->showBrand();         // বাইরে থেকে public method access করা

           

                   অন্য class  : কোন একটা  class থেকে অন্য একটা  class এর public method/property access করা যায়। 
         ...
         protected : protected property বা method কে সরাসরি object  তৈরী করে  access করা যায় না। এটা কে কেবল নিজ class এর ভিতর এবং child class থেকে access করা যায়। 
                ...
                child class থেকে access :
                 ...
                 private : private property বা method কে সরাসরি object  তৈরী করে  access করা যায় না এবং কি  child class থেকে access করা যায় না ।  
        ...
        Inheritance : Inheritance মানে হল উত্তরাধিকার। একটু অন্য ভাবে বলতে গেলে একজন সন্তানের যেমন নিজের কিছু ব্যক্তিগত সম্পদ থাকে, 
    ...
    Polymorphism : Polymorphism হল OOP-এর একটি ধারণা, যেখানে একই নামের একটি মেথড (function) বিভিন্ন class-এ ভিন্নভাবে কাজ করে, 
        ...
        Interface : Interface হলো এমন একটি কাঠামো (structure), যেখানে শুধু method-এর নাম define করা হয়, কিন্তু method-এর ভিতরে কী কাজ হবে — সেটা define করা হয় না। 
      ...
      Abstract Class : এটা একটা আধা-সম্পূর্ণ class — কিছু কাজ নিজে করে, কিছু future subclass দিয়ে করায়। একটু বুঝিয়ে বলতে গেলে। 
    ...
    📊 তুলনামূলক চার্ট (Interface vs Abstract Class):
     ...
     Traits :  Trait হলো PHP-র একটি special feature, যেটা ব্যবহার করা হয় code reuse (একই কোড বারবার লেখার ঝামেলা থেকে বাঁচতে)।
            ...
            Static Keyword : আমরা জানি কোনো class এর method বা property access করতে হলে। ওই class এর object এর মাধ্যমে করতে হয়। কিন্তু 
                কোন class এর method বা property তে Static Keyword use করলে তাকে object ছাড়াই , সরাসরি class দিয়া access করা যায়।  নিচে একটা উদাহরণ দেয়া হল 
    ...
    Final Keyword : সাধারণত php তে একটা subclass parent class কে extends করতে পারে এবং চাইলে  তার method কে override করতে পারে। 
    ...
    Type Hinting : PHP-তে Type Hinting মূলত function/method-এর parameter এবং return type-এর ক্ষেত্রেই ব্যবহৃত হয়। 
      ...
      Exception Handling : যখন কোডে কোনো ভুল (Error) হয় —তখন PHP যেন চিৎকার করে বন্ধ হয়ে না যায়, বরং শান্তভাবে ভুলটাকে ধরে ফেলতে পারে এবং তুমি ইচ্ছামতো তা হ্যান্ডেল করতে পারো। 
  ...
  ***********************************************************************************************************************
  SOLID Principles : SOLID হচ্ছে  OOP-এর ৫টা গুরুত্বপূর্ণ নিয়ম/নীতি। যেটা Software Development-এ code clean, flexible, scalable রাখতে সাহায্য করে।     
  ...
  🔠 SOLID এর ফুল ফর্ম:
    ...
    Single Responsibility Principle (SRP) : এর অর্থ হচ্ছে ১টা ক্লাসের ১টাই কাজ থাকবে। মানে হচ্ছে ১টা class এর মধ্যে একটা নির্দিষ্ট কাজ গুলো
   ...
   🔠 OCP = Open/Closed Principle : ✅ "A class should be open for extension, but closed for modification." অর্থাৎ :"তুমি নতুন কিছু যোগ করতে পারো (extend), কিন্তু পুরাতন কোডে হাত দিতে পারবে না (modify না করেই কাজ হবে)।"
        ...
        কেন দরকার?
        তুমি যখন একটা সফটওয়্যার বানাও, ভবিষ্যতে অনেক সময় নতুন feature যোগ করতে হয়। যদি তুমি বারবার পুরাতন কোডে গিয়ে modify করো, তাহলে পুরাতন ফিচার নষ্ট হতে পারে (bug)!এই কারণে OCP কনসেপ্ট টা দরকার .
    ...
    🔠 L - Liskov Substitution Principle (LSP) : এটি SOLID এর তৃতীয় নিয়ম।  Barbara Liskov নামে একজন বিজ্ঞানী এটি প্রস্তাব করেন।"Child class গুলো parent class এর behavior ঠিকঠাকভাবে ধরে রাখবে। 
            অর্থাৎ যেখানে parent class use করা হয়, সেখানে তার child class বসালেও সব ঠিকমতো কাজ করবে।" এটাই হল LSP নিয়ম। অন্য ভাবে বললে parent class যেটা করার কথা, child class সেটার অন্য রকম আচরণ করলে এটা LSP ভাঙবে ❌
            ...
            ✅ ঠিক পদ্ধতি (LSP মেনে চলে):
                ...
                এখানে Bird parent class তাকে extends করে বানানো হয়েছে FlyingBird . আবার FlyingBird কে extends করে Sparrow . এখানে যেটা হচ্ছে   Bird খায় , FlyingBird খায় এবং উড়ে ,Sparrow খায় এবং উড়ে, ফলে এদের মধ্যে একটা মিল রয়েছে অর্থাৎ parent এবং child class এর মধ্যে একটা মিল রয়েছে। 
    ...
    🔠 Interface Segregation Principle (ISP) : কোনো class কে এমন interface implement করতে বাধ্য করো না, যেটার সব ফিচার তার দরকার নেই।"অন্য ভাবে "একটা class কে এমন কিছু করতে বাধ্য না করা , যেটা সে জানেই না বা দরকার নাই।"
        ...
        এখানে Worker একটা interface যার মধ্যে দুইটা method আছে , আবার Robot class এই Worker interface কে implements করেছে। আমরা জানি কোনো class যদি কোনো interface implements করে তাহলে ওই class কে ওই interface এর সব method অব্যশই ব্যবহার করতে হবে। 
    ...
    🔠 D — Dependency Inversion Principle (DIP) : সহজ ভাবে বলতে গেলে উচ্চ স্তরের ক্লাস যেন নিচু স্তরের ক্লাসের উপর নির্ভর না করে। বরং উচ্চ স্তরের ক্লাস  interface বা abstract-এর উপর নির্ভর করবে (একটা নিয়ম মেনে কাজ করবে )।
            ...
            High-Level Class and Low-Level Class : এটা একটা thinking এর বিষয় , এক এক জন, এক এক ভাবে এটা ভাগ করবে যে কোনটা High-Level Class আর কোনটা  Low-Level Class .এক এক  জনের চিন্তা এক এক রকম হবে। 
                ...
                ১. প্রজেক্টের প্রথম দিকে, আমাদের ডিসিশন নিতে হবে যে , কোন পার্ট গুলো আমাদের প্রজেক্ট এর জন্য খুবই গুরথপুর্ণ। যেগুলো না থাকলে প্রজেক্ট চালানো যাবে না। আমাদের main business লজিক গুলো। এই জিনিস গুলো যাবে আমাদের high level এ। ধরা যাক e-commerce সাইট। 
                ...
                যেমন:
                    ...
                    * FileUploader[common ]
                আরেকটা জিনিস যেটা, প্রায় সব প্রজেক্টই এইগুলো কমন থাকে , এই কাজ গুলো করার জন্য যে  ক্লাস আছে সেগুলো  হচ্ছে  Low-Level Class .
                মোট কথা হল , যেটাই আপনি High-Level ,Low-Level করেন না কেন।  খেয়াল রাখতে হবে High-Level-class  যেন Low-Level-class এর উপর নির্ভর না করে।
...
<!-- 
    ...
    Design Patterns : Design Pattern মানে হলো কিছু "tested & proven" কোডের ধরন বা “solution idea” . 
    ...
    ১. Creational Patterns (Object কিভাবে বানাবো)
    ...
    ২. Structural Patterns (Object গুলা কিভাবে যুক্ত হবে)
    ...
    ৩. Behavioral Patterns (Object কিভাবে কথা বলবে/ব্যবহার করবে)
